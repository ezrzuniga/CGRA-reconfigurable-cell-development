...
############################################################
# run_hls.tcl -- FIR_Spatial_Top_C (4 PE_MAC cells in 1x4, 1 invocation)
# Target: xck26-sfvc784-2LV-c, 4 ns / 250 MHz
# Usage: vitis-run --mode hls --tcl run_hls.tcl
############################################################
set PROJECT_NAME "fir_spatial_cgra_c_prj"
set SOLUTION_NAME "solution1"
set TOP_MODULE    "FIR_Spatial_Top_C"
set CLK_PERIOD_NS 4.0
set FPGA_PART     "xck26-sfvc784-2LV-c"

open_project -reset $PROJECT_NAME
add_files fir_spatial_hls_top_c.cpp -cflags "-std=c++17"
add_files -tb ../../Proyecto_C/fir_hls_c/FIR_Spatial_Top_C__TB.cpp -cflags "-std=c++17 -Wno-unknown-pragmas"
set_top $TOP_MODULE
