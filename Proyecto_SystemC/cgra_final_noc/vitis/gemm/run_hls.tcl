...
############################################################
# run_hls.tcl
# Automated Vitis HLS 2024.1 flow for GEMM_NoC_HLS_Top_C -- sintetiza la
# CGRA_Final_NoC_Mesh_C REAL (malla 3x3 heterogenea sobre la fabrica de
# routers NoC), no un kernel aritmetico aparte. Ver
# ../../../../Proyecto_C/cgra_final_noc_c/GEMM_NoC_HLS_Top_C.h para el diseno
# completo.
...
set PROJECT_NAME "gemm_noc_prj"
set SOLUTION_NAME "solution1"
set TOP_MODULE    "GEMM_NoC_HLS_Top_C"
...
add_files gemm_noc_hls_top_c.cpp -cflags "-std=c++17"
add_files -tb ../../../../Proyecto_C/cgra_final_noc_c/GEMM_NoC_HLS_Top_C__TB.cpp -cflags "-std=c++17 -Wno-unknown-pragmas"
