...
\begin{itemize}
    \item \textbf{RTL:} 4 celdas + router NoC básico, modelados en C/C++ (Vitis HLS) con SystemC como referencia de comportamiento, no en VHDL escrito a mano -- Vitis HLS 2024.1 genera el RTL/IP de síntesis a partir de ese modelo (\texttt{csynth\_design}).
